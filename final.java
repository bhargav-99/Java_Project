...
{ 
    ...
    void signup()
    {
        ...
        System.out.println(bold+yellow+"\t\t\t\t\t******           SIGNUP              ******");
        System.out.println(bold+def+"\t\t\t\t\t    -------------------------------------"+"\n");
        boolean frname=true;
        while(frname)
        {
    ...
    {
        System.out.println(bold+def+"\t\t\t\t\t    -------------------------------------");
        System.out.println(bold+yellow+"\t\t\t\t\t******           SIGNIN              ******");
        System.out.println(bold+def+"\t\t\t\t\t    -------------------------------------"+"\n");
...
class elite 
{
    ...
    public static void main(String []args)
    {
        ...
        while(b)
        {
            System.out.println(bold+yellow+"PLEASE ENTER 1 FOR SIGNUP or 2 FOR SIGNIN ");
            System.out.print(def);
            int s=sc.nextInt();
            switch(s)
            {
        ...
        while(opt)
        {
                        System.out.println(bold+blue+"\t\t\t\t\t     --------CHOOSE YOUR VEHICLE--------");
			System.out.println(bold+def+"\t\t\t\t*-----------------------------------------------------------*");
